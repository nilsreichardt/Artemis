    ...
    private initWorkingTimeForm() {
        ...
        this.workingTimeForm = new FormGroup({
            minutes: new FormControl(
                {
                    value: parseInt(workingTimeParts[0] ? workingTimeParts[0] : '0', 10),
                    disabled: !!this.exam.visible,
                },
                [Validators.min(0), Validators.required],
            ),
            seconds: new FormControl(
                {
                    value: parseInt(workingTimeParts[1] ? workingTimeParts[1] : '0', 10),
                    disabled: !!this.exam.visible,
                },
                [Validators.min(0), Validators.max(59), Validators.required],
            ),
        });
    }
}
