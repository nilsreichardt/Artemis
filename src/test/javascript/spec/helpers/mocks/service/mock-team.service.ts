...
export const mockTeamStudents = [
    {
        ...
        visibleRegistrationNumber: '01234567',
    },
    {
        id: 2,
        firstName: 'Sidney',
        ...
        login: 'ga23bcd',
        email: 'sidney.humphrey@example.com',
    ...
    },
    {
        ...
        name: 'Elane Cravens',
        login: 'ga34cde',
        email: 'elane.cravens@example.com',
        visibleRegistrationNumber: '01234569',
    },
] as User[];
...
export const mockNonTeamStudents = [
    ...
    },
    {
        ...
        name: 'Debbie Roman',
        login: 'ga56efg',
        email: 'debbie.roman@example.com',
    },
    {
        id: 6,
        firstName: 'Jeffrey',
        ...
        name: 'Jeffrey McGill',
        login: 'ga67ghi',
        email: 'jeffrey.mcgill@example.com',
    },
] as User[];
...
export const mockSourceTeamStudents = [
    {
        ...
        name: 'Alice McCarthy',
        login: 'ga78abc',
        email: 'alice.mccarthy@example.com',
    ...
    },
    {
        ...
        name: 'Lena Dudley',
        login: 'ga89bcd',
        email: 'lena.dudley@example.com',
        visibleRegistrationNumber: '11234568',
    },
    {
        id: 9,
        firstName: 'Thomas',
        ...
        visibleRegistrationNumber: '11234569',
    },
] as User[];
...
export const mockSourceExercise = {
    id: 2,
    title: 'Source Programming exercise',
    teamAssignmentConfig,
    course: mockCourse,
} as ProgrammingExercise;
...
export const mockFileStudents = [
    ...
    { firstName: 'Jackie', lastName: 'Doen', username: 'jackie_doen', teamName: 'File Team 1' } as StudentWithTeam,
    {
        firstName: 'Alyson',
        lastName: 'Smithson',
        registrationNumber: '23458',
        teamName: 'File Team 2',
    } as StudentWithTeam,
        ...
        students: [
            {
                ...
                login: 'jack_doe',
                name: 'Jack Doe',
                visibleRegistrationNumber: undefined,
            } as User,
            {
                ...new User(),
                firstName: 'Jackie',
        ...
        students: [
            {
                ...
                lastName: 'Smithson',
                login: undefined,
                visibleRegistrationNumber: '23458',
                name: 'Alyson Smithson',
            } as User,
            {
                ...new User(),
                firstName: 'Alysia',
                lastName: 'Smith',
                login: undefined,
                visibleRegistrationNumber: '23459',
                name: 'Alysia Smith',
            } as User,
        ],
    } as Team,
...
export class MockTeamService implements ITeamService {
    ...
    findCourseWithExercisesAndParticipationsForTeam(course: Course, team: Team): Observable<HttpResponse<Course>> {
        return MockTeamService.response({
            ...mockCourse,
            exercises: [{ ...(mockExercise as Exercise), teams: [mockTeam] }],
        } as Course);
    }
