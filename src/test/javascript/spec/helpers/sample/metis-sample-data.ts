...
export const metisSlide1 = {
    id: 1,
    slideNumber: 1,
    slideImagePath: 'directory/attachments/slides/Metis-Slide-1.png',
} as Slide;
export const metisAttachment = {
    id: 1,
    name: 'Metis Attachment',
    link: 'directory/attachments/Metis-Attachment.pdf',
} as Attachment;
...
export const metisLecture3 = {
    id: 3,
    title: 'Third Metis  Lecture 3',
    attachments: [metisAttachment],
    lectureUnits: [metisAttachmentUnit],
} as Lecture;
